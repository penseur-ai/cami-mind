...
class TemporalPooler:
    ...
    def __init__(self, cell, columnDim, cellsPerColumn, maxSegmentsPerCell, maxSynapsesPerSegment,
        ...
        if learn:
            for i, j in predictedCells:  # for active predicted cells
                self._cells[i][j].adaptActiveSegments(prevActiveCells,
                                                      self._maxNewSynapses, prevWinnerCells,self._initialPermanence,
                                                      self._permanenceInc, self._permanenceDec)
        ...
        for column in burstingColumns:
            ...
            if np.max(maxActivePotentials) > 0:
                ...
                if learn:
                    ...
                    self._cells[column][winnerCell].adaptMatchingSegment(segment,
                                                                         prevWinnerCells,
